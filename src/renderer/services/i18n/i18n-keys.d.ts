...
export type I18nKey =
  ...
  | 'settings.apiKeySource.infisical'
  | 'settings.apiKeySource.inline'
  ...
  | 'settings.infisical.environment'
  | 'settings.infisical.projectId'
  | 'settings.infisical.secretName'
  | 'settings.infisical.secretPath'
  | 'settings.infisical.testConnection'
  | 'settings.infisical.testFailed'
  | 'settings.infisical.testSuccess'
  | 'settings.installed'
  | 'settings.language'
  | 'settings.lark.agent'
